...
//     */
//
//    private static final User user000 = new User("Aaron", "Zelenski", "@aaron", "s3://tweeterprofileimagebucket/@aaron");
//
//    private static final User user00 = new User("Lucy" , "Zelenski", "@lucy", "s3://tweeterprofileimagebucket/@lucy");
//
//    private static final User user0 = new User("Paul" , "Zelenski", "@paul", "s3://tweeterprofileimagebucket/@paul");
...
//            user000, user00, user0, user1, user2, user3, user4, user5, user6, user7, user8, user9, user10, user11,
